...
class ApiRos:
    ...
    def setUser( self,user, group, password):
        self.inputsentence = ["/user/add"]
        self.inputsentence.append("=name=" + user)
    ...
    def setssh( self,key, name):
        self.inputsentence = ["/user/ssh-keys/import"]
        self.inputsentence.append("=public-key-file=" + key)
        self.inputsentence.append("=user=" + name)
        self.writeSentence(self.inputsentence)
        self.readSentence()

    def printssh(self):
        self.inputSentence = ["/user/ssh-keys/print"]
        self.inputSentence.append('=count-only=')
        self.writeSentence(self.inputSentence)
        count = int(self.readSentence()[1][5:])
        for items in range(count):
    ...
    def delessh(self,number):
        self.inputsentence = ["/user/ssh-keys/remove"]
        self.inputsentence.append("=numbers=" + number)
        self.writeSentence(self.inputsentence)
        self.readSentence()
...
def main():
    ...
    elif sys.argv[1] == "print2":
        apiros.printssh();
    elif sys.argv[1] == "create2":
        apiros.setssh(sys.argv[2], sys.argv[3]);
    elif sys.argv[1] == "delete2":
        apiros.delessh(sys.argv[2]);
